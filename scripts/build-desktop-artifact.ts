...
const DESKTOP_APP_ID = "com.codepanda.t3code-auto";
...
export function resolveDesktopProductName(_version: string): string {
  return desktopPackageJson.productName ?? "T3 Code Auto";
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "T3-Code-Auto-${version}-${arch}.${ext}",
  ...
  if (platform === "mac") {
    ...
    buildConfig.mac = {
      ...
      protocols: [
        {
          name: "T3 Code Auto",
          schemes: ["t3code-auto", "t3code-auto-dev"],
        },
      ],
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  const stagePackageJson: StagePackageJson = {
    ...
    private: true,
    packageManager: rootPackageJson.packageManager,
    description: "T3 Code Auto desktop build",
    author: "CodePanda",
...
const buildDesktopArtifactCli = Command.make("build-desktop-artifact", {
  ...
  Command.withDescription("Build a desktop artifact for T3 Code Auto."),
