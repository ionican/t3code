...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "t3code-auto-dev" : "t3code-auto",
    legacyUserDataDirName: isDevelopment ? "T3 Code Auto (Dev)" : "T3 Code Auto (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t3code-auto-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        "setPath:userData:/tmp/app-data/t3code-auto-dev",
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "t3code-auto-dev" },
    { isDevelopment: false, scheme: "t3code-auto" },
