...
const BOOT_SERVICE_NAME = "t3code-auto";
export const BOOT_SERVICE_UNIT_FILE = `${BOOT_SERVICE_NAME}.service`;
// `.service` suffix keeps the label distinct from the desktop app's bundle id
// (com.codepanda.t3code-auto), so launchd and TCC records never collide.
export const BOOT_SERVICE_LAUNCHD_LABEL = "com.codepanda.t3code-auto.service";
